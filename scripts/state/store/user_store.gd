...
var state;
var userDefaultStateResource: UserDefaultStateResource = UserDefaultStateResource.new();
var controller := preload("res://scripts/state/user_state_controller.gd");
var stateController;


func _init() -> void:
	print('UserStore._init')
	state = userDefaultStateResource;
